...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = CustomUser
        fields = ['id', 'email', 'first_name', 'last_name', 'pfp', 'locale', 'username', 'changedUsername', 'credits', 'notifications', 'old_notifications', 'saved_items', 'is_premium', "activity", "streak", "current_week_data", "quiz_data", "greenWall", "studyProgress", "studyPreference", "paymentMethods", "lastNicknameChange", "lastPurchaseDate", "lastRefillDate"]
