...
from .views import registerUser, UserInitApi, set_username, set_data, UserInfoView, update_saved_data, mark_notifications_read,EditCollectionView, update_activity
...
urlpatterns = [
    ...
    path('edit-preferences/', EditCollectionView.as_view(), name='edit-prefs'),
]
